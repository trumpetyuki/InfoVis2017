function Isosurfaces( volume, isovalue )
{
    ...
    color = new THREE.Color().setHex( cmap[255][1] );
    // Draw color map
    ...
    for ( var z = 0; z < volume.resolution.z - 1; z++ )
    {
        for ( var y = 0; y < volume.resolution.y - 1; y++ )
        {
		    ...
		    /*var S0 = (scalars[id0]-0.1)/0.7*255;
		    var S1 = (scalars[id1]-0.1)/0.7*255;
		    var S2 = (scalars[id2]-0.1)/0.7*255;
		    ...
		    /*geometry.id0.vertexColors.push( C0 );
		    geometry.id1.vertexColors.push( C1 );
		    geometry.id2.vertexColors.push( C2 );*/
